(
	a simple blink program for the msp430fr2433
	microcontroller, that will be used in the display!

	written on 1202509265.022212 by dwrr
)

(a simple blink program for this microcontroller, that will be used in the display eventually)
(written on 1202509265.022208 by dwrr)
...
(constants for the msp430fr2433 specifically)

set start_of_fram 		0000_0000_0010_0011

set reset_vector    		0111_1111_1111_1111
set wdt_interrupt_vector 	0110_0111_1111_1111
set p1_interrupt_vector    	0011_1011_1111_1111
set ucb0tx_interrupt_vector     0000_0111_1111_1111

set start_of_memory 		0000_0000_0000_0100
set end_of_memory 		1111_1111_1111_0100

set start_of_stack end_of_memory
sub start_of_stack 1000_1

set sfrie 	0000_0000_1000_0000
set sfrifg 	0100_0000_1000_0000
set sfrrpcr 	0010_0000_1000_0000

set csctl0 0000_0001_1000_0000
set csctl1 0100_0001_1000_0000
set csctl2 0010_0001_1000_0000
set csctl3 0110_0001_1000_0000
set csctl4 0001_0001_1000_0000
set csctl5 0101_0001_1000_0000
set csctl6 0011_0001_1000_0000
set csctl7 0111_0001_1000_0000
set csctl8 0000_1001_1000_0000

set pm5ctl0 0000_1100_1000_0000
set wdtctl  0011_0011_1000_0000 
set frctl0  0000_0101_1000_0000

set p1in   0000_0000_0100_0000
set p1out  0100_0000_0100_0000
set p1dir  0010_0000_0100_0000
set p1ren  0110_0000_0100_0000
set p1sel0 0101_0000_0100_0000
set p1sel1 0011_0000_0100_0000

set p2in   1000_0000_0100_0000
set p2out  1100_0000_0100_0000
set p2dir  1010_0000_0100_0000
set p2ren  1110_0000_0100_0000
set p2sel0 1101_0000_0100_0000
set p2sel1 1011_0000_0100_0000

set p3in   0000_0100_0100_0000
set p3out  0100_0100_0100_0000
set p3dir  0010_0100_0100_0000
set p3ren  0110_0100_0100_0000
set p3sel0 0101_0100_0100_0000
set p3sel1 0011_0100_0100_0000

set ucb0ctl0	1000_0010_1010_0000
set ucb0ctl1	0000_0010_1010_0000
set ucb0br0	0110_0010_1010_0000
set ucb0br1	1110_0010_1010_0000
set ucb0stat	0001_0010_1010_0000
set ucb0rxbuf	0011_0010_1010_0000
set ucb0txbuf	0111_0010_1010_0000
set ucb0ie	0101_0110_1010_0000
set ucb0ifg	0011_0110_1010_0000
...
sect start_of_memory
	...
	mo m_mov  fixed_mode fixed_reg ucb0ctl1  imm_mode imm_reg 1000_0011_1001_0001 size_word
...
1202509265.024254
coding up a simple blinky program to see if the msp430fr2433 is suitable for controlling the display!!

going well so far, getting the low power interrupt driven blinkprogram working nowww
...
at mainloop 
	...
	at outter
		...
		at inner
			mo m_sub reg_mode 101 0 const1_mode const1_reg 0  size_word
			mb condjnz inner del inner
		mo m_sub reg_mode 001 0 const1_mode const1_reg 0 size_word
