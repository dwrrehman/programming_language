...
at msp_nop
	...
	mo msp_mov reg_mode r4 0  reg_mode r4 0  size_word
...
(set flash_start 0000_0000_0000_0011
set flash_end   1111_1111_1111_1111
set ram_start 	0000_0000_0100_0000
set ram_end 	1111_1111_1100_0000)
...
sect start_of_flash
	...
	mo msp_mov  reg_mode sp 0   imm_mode imm_reg start_of_stack   size_word
	mo msp_mov  fixed_mode fixed_reg wdtctl   imm_mode imm_reg 0000_0001_0101_1010   size_word

	mo msp_mov  fixed_mode fixed_reg p2dir    imm_mode imm_reg 1111_1111   size_byte
	mo msp_mov  fixed_mode fixed_reg p2out    imm_mode imm_reg 0 size_byte
	mo msp_mov  fixed_mode fixed_reg p2sel    imm_mode imm_reg 0 size_byte

	mo msp_mov  fixed_mode fixed_reg p1dir    imm_mode imm_reg 0001_1111 size_byte
	mo msp_mov  fixed_mode fixed_reg p1out    imm_mode imm_reg 0 size_byte
	mo msp_mov  fixed_mode fixed_reg p1sel    imm_mode imm_reg 0 size_byte

	mo msp_bis  fixed_mode fixed_reg p1ie     imm_mode imm_reg 11 size_byte
	mo msp_bis  fixed_mode fixed_reg p1ies    imm_mode imm_reg 11 size_byte
	
at loop

	mo msp_bis  reg_mode sr 0  imm_mode imm_reg 0001_1111_0000_0000  size_word   (go to sleep in LPM4)
	mb condjmp loop
	msp_nop

m4_sect flash_interrupt_vector

	mo msp_xor  fixed_mode fixed_reg p2out    imm_mode imm_reg 1111_1111   size_byte
	mo msp_xor  fixed_mode fixed_reg p1out    imm_mode imm_reg 0001_1111   size_byte

	mo msp_bic  fixed_mode fixed_reg p1ifg    imm_mode imm_reg 11 size_byte
	reti
	msp_nop


sect p1_interrupt_vector
	emit 01 flash_interrupt_vector
