...
static nat 
	ct_pc = 0, rt_pc = 0, literal = 0, mode = 0, macro = 0, comment = 0, 
	literalmacro = 0, include = 0, name_count = 0, stack_pointer = 0, 
	base_pointer = 0, ins_count = 0, rt_ins_count = 0;
static nat dict_length = 0, dict_begin = 0, word_count = 0, word_pc = 0, file_stack_count = 0;
