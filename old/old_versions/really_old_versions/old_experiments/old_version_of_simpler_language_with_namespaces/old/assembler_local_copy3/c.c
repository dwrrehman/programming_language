...
/*
		...
		else if (e == ior)	{ array[a0] = array[a1] | array[a2]; arg_count -= 2; arguments[arg_count - 1] = a0; }
		// else if (e == or)	{ array[a0] = array[a1] | a2; arg_count -= 2; arguments[arg_count - 1] = a0; }
		else if (e == eor)	{ array[a0] = array[a1] ^ array[a2]; arg_count -= 2; arguments[arg_count - 1] = a0; }
		// else if (e == xor)	{ array[a0] = array[a1] ^ a2; arg_count -= 2; arguments[arg_count - 1] = a0; }
	...
	// 	} else if (e == jal) { // only do this one, if the imm bit is set lol. 
